...
public class Testcrawler {
	...
	public static void main(String args[]) {
		...
		Testcrawler.mutation_rate = 0.01;
		Testcrawler.crossover_rate = 0.8;
		Testcrawler.number_generation = 200;
		// so nst trong quan the
		int num_nst = 30;
		// seed url
		
		String url="http://www.skysports.com/";
...
//			}
			...
			if (doc_weight.size() == num_nst) {
				...
				System.out.println("keyword 2 before ="+ keyword_2+"\n");
				...
				for(int j=0;j<new_key.size();j++) {
					...
					if(get) {
						...
						Newkeyword.saveDocument(new_key.get(j), link_new_key.get(j),weight);
					}
					
				}
				System.out.println("keyword 2 after ="+ keyword_2+"\n");

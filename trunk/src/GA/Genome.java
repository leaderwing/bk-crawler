...
public class Genome {
    ...
    public Genome() {
        ...
        //.m_chromosomes = new ArrayList<Chromosome>();
    }

    public Genome(ArrayList<Double> m_chromosomes) {
    ...
    public void Mutate() {
    	int pos = m_random.nextInt(this.m_chromosomes.size());
    	this.m_chromosomes.set(pos, m_random.nextDouble());
    }

...
public class ConnectDatabase {
	...
	private static String dbName = "search";
	...
	protected static Connection connectDb() {
		...
		try {
			...
			ConnectDatabase.conn = DriverManager.getConnection(ConnectDatabase.url + ConnectDatabase.dbName+"?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true",
